...
export const swap = async (privateKey: string, poolInfo: ApiV3PoolInfoStandardItem, amountIn:number, inputMint: string=NATIVE_MINT.toBase58(), slippage:number = 0.01, microLamports: number) => {
